define([
    ...
    function delete_subject() {
        ...
        root.on('click', '.delete-subject', function(e) {
            e.preventDefault();
            ...
            runAfterSaveIfDirty(planid,function(){
                ...
                {key: 'deletesubjectconfirm', component: 'local_curriculum'},
                {key: 'yes', component: 'core'},
                {key: 'no', component: 'core'},
                {key: 'subjectdeleted', component: 'local_curriculum'},
                {key: 'subjectdeleteerror', component: 'local_curriculum'}
                    ...
                    Notification.confirm(
                        ...
                        function() {
                            Ajax.call([{
                                methodname: 'local_curriculum_delete_subject',
                                args: {
                                    subjectid: subjectid
                                }
                            }])[0].then(function() {
